...
class OnlineResultScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final results = MockOnlineData.generateResults(question, selectedOptionId);

    final totalVotes = results.values.fold<int>(
      0,
      (sum, count) => sum + count,
    );

    final agreedCount = results[selectedOptionId] ?? 0;
