...
class _ProfileScreenState
  ...
  void _openQuestion(
    ...
    // Profile-created questions open
    // through a lightweight publisher object.
    final publisher =
        PublisherAdapter.fromUser(
      publisherUser,
    );
  ...
  Widget build(BuildContext context) {
    ...
    final publishedQuestions =
        _questionStore.byAuthor(
      viewedUser.id,
    );
